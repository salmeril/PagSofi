...
function addMessage(content, isAudio = false, audioSrc = null, audioId = null, images = [], showLink = false, linkText = '', linkHref = '', isUser = false) {
    ...
    if (isAudio) {
        ...
        if (showLink) {
            ...
            link.href = linkHref; // Evitar redirección inmediata
            ...
            link.addEventListener('click', function(e) {
                ...
                const userReply = "TIPOS DE PERSONAJES";
...
// Definir los flujos de mensajes (4 audios y después un texto con link)
const firstMessages = [
    { audio: '/infografia-1/src/audio/audiomessi2.mp3', id: 1 },
    { audio: '/infografia-1/src/audio/audiomessi3.mp3', id: 2 },
    { audio: '/infografia-1/src/audio/audiomessi4.mp3', id: 3 },
    { audio: '/infografia-1/src/audio/audiomessi6.mp3', id: 4 },
    {
        content: "Ahora chusmeá los tipos de personajes seguro te gustan ",
        showLink: true,
        linkText: "USOS TIPOS DE PERSONAJES",
        linkHref: "/Infografia-1/page/messichat3.html"
    }
];

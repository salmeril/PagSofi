    ...
    if (isAudio) {
        ...
        if (showLink) {
            ...
            link.addEventListener('click', function(e) {
                ...
                const userReply = "SABER LAS CONTRAS DE CARACTER IA";
...
const firstMessages = [
    ...
    "Sigue escuchando! ",
    "Te diré todo lo bueno de usar character ai",
    { audio: '/infografia-1/src/audio/pros2chayanne.mp3', id: 2 },
    { audio: '/infografia-1/src/audio/pros3chayanne.mp3', id: 3 },

    {
        content: " ",
        showLink: true,
        linkText: "SABER LAS CONTRAS DE CARACTER IA",
        linkHref: "/infografia-1/page/chayannechat2.html"
    }
];

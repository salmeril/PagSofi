...
const firstMessages = [["<strong>🌍 La huella de carbono generada por el entrenamiento de AI es igual a:</strong>",
    "1-🚗 Conducir millones de kilómetros en un auto",
    "2-🏠 Alimentar cientos de hogares durante un año." 
    ].join("<br>"), // Une los mensajes con <br> para que no aparezcan las comas
...

    {
        ...
        showLink: true,
        linkText: "DESPEDIRSE",
        linkHref: "/infografia-1/page/chayanefin.html"
